    ...
    <main className=" h-full w-full flex justify-center">
      ...
      <section className={`h-auto w-[90%] my-12 flex flex-col justify-center px-5 ${confirmOrder ? 'hidden' : 'block'}`}>
        <table className="w-full ">
          ...
          <tbody>
            {cartItem.map((item) => (
              <tr key={item.item.id} className="border-b-2 border-[#ff5d6b]">
                {/* product  */}
                <td className="flex flex-col sm:flex-row  justify-center sm:gap-6 gap-3 py-5">
                  ...
                  <div>
                    ...
                    <button
                      ...
                      className="text-red-700 hover:text-[#1f1f1f]  ml-3 transition duration-200 underline "
                    >
                      Remove
                    </button>
                  </div>
                ...
                <td>
                  <div className="flex items-center sm:w-32 w-20 border border-[#AD343E] overflow-hidden">
                    <button
                      className="sm:px-3 px-2 font-bold w-full py-1 bg-[#AD343E] hover:bg-[#a12f39] text-white"
                    ...
                    <button
                      ...
                      className="sm:px-3 px-2 font-bold w-full py-1 bg-[#AD343E] hover:bg-[#a7313b]  text-white"
                    >
                      +
                    </button>
                  </div>
        ...
        <Button variant="destructive"  className="bg-[#c03944]  text-white hover:bg-[#AD343E] font-bold text-xl " onClick={()=> OrderConfirm()}>Confirm Order</Button>
      </section>
      {confirmOrder ?
      ...
      <div className="max-w-md w-full p-6 bg-white shadow-lg rounded-lg text-center">
        <h1 className="text-2xl font-bold text-[#c03944] mb-4">✅ Order Confirmed!</h1>
        <h2 className="text-lg text-gray-700 mb-6">
          Your order has been Successfully Placed. Thank You for Shopping with us!
        </h2>
        <Button asChild className="bg-[#c03944] text-white px-6 py-2 rounded hover:bg-[#d8404d]">
      ...
      :(
        ...
        <div className="text-center max-w-lg w-full  shadow-lg rounded-xl py-6 px-4 space-y-6">
          <h2 className="text-[#AD343E]  font-extrabold text-2xl ">
          ...
          <Link
            href="/menue"
            className="inline-block bg-[#AD343E]  text-white font-medium py-2 px-4 rounded-md text-lg md:text-xl lg:text-2xl hover:bg-[#cf4450]  transition duration-300"
          >
            Continue Shopping
          </Link>
        </div>
