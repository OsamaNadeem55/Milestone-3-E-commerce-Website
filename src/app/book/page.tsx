  ...
  return (
    <main className="h-full">
      ...
      <section className="flex flex-col items-center">
        ...
        We Take into Account all the Factors Driving Transformation, Providing you with the Essential Elements. <br />
        You must Adapt to Bring About Real Transformation..
        </p>
          ...
          <form method="post">
            ...
            <div className="flex sm:flex-row flex-col gap-4 items-center">
              ...
              <div className="flex flex-col w-full">
                ...
                >
                  <option value="06:30 pm">07:00 pm</option>
            ...
            <button
              type="submit"
              className="bg-[#AD343E] w-full text-white font-bold p-3 rounded-full mt-5"
            >
              Reserve Table
            </button>
          </form>
